	 	         ...
	 	         if (m_fmd1 == null)
		         {
	 	        	 if (!m_first)
	 	        	 {
	 	        		if (m_text_conclusion.getText().length() == 0)
	 	        		{
			 	        	 ...
			 	        	 m_text_conclusion.setText(conclusion); 
			 	        	 
			 	        	 if (m_score != -1)
			 	        	 {
			        			 DecimalFormat formatting = new DecimalFormat("##.######");
			 	        		 m_text_conclusion.append(" (Dissimilarity Score: " + String.valueOf(m_score)+ ", False match rate: " + Double.valueOf(formatting.format((double)m_score/0x7FFFFFFF)) + ")");
			 	        	 }	 	        			
	 	        		}
	 	        	 }
	 	        	 
		        	 m_text.setText("Place your thumb on the reader");
		         }
	 	         else if (m_fmd2 == null)
	 	         {
		        	 m_first = false;
		        	 m_text.setText("Place your index finger on the reader");
	 	        	 
	 	         }
	 	         else if (m_fmd3 == null)
	 	         {
		        	 m_first = false;
		        	 m_text.setText("Place your middle finger on the reader");
	 	        	 
	 	         }
	 	         else if (m_fmd4 == null)
	 	         {
		        	 m_first = false;
		        	 m_text.setText("Place your ring finger on the reader");
